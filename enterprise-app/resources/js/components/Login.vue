<template>
    <div class="min-h-screen bg-slate-900 flex items-center justify-center p-4 relative overflow-hidden font-sans">
        ...
        class="max-w-4xl w-full bg-slate-50 rounded-[2.5rem] shadow-[0_35px_60px_-15px_rgba(0,0,0,0.5)] overflow-hidden
        ...
        <div class="md:w-1/2 p-10 md:p-14 flex flex-col justify-center">
            ...
            <form @submit.prevent="handleLogin" class="space-y-6">
                <div class="space-y-2">
                    <label class="block text-xs font-bold text-slate-500 uppercase tracking-widest ml-1">Email</label>
